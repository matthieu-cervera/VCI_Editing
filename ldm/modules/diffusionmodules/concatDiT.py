...
class BasicTransformerBlock(nn.Module):
    def __init__(self, dim, n_heads, d_head, dropout=0., gated_ff=True, context_dim=None, checkpoint=True): # 1 self 1 cross or 2 self
        super().__init__()
