# file audioldm/utils.py from ZETA repo - modified to mitigate the issue of getting duration with certain wav files
...
def get_duration(fname):
    ...
    print(f"Failed : using default duration for {fname}")
    return 10.0
